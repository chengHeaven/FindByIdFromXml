...
public class EventLogger {
    private static final String GROUP_ID = "FindByIdFromXml";//The unique group id where "Event Log" could use to group your messages together.
    private static final String TITLE = "FindByIdFromXml Event Log";//The title on Balloon
